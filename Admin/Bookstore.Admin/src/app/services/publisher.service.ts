...
export class PublisherService {
  ...
  getPubliserName(): Observable<MetaData[]> {
    return this.http.get<MetaData[]>(ApiUrls.MetaData.publishers);
  }
    ...
    return [
      {
        ...
        description:
          'One of the largest book publishers in the world, known for its diverse range of genres.',
      ...
      },
      {
        ...
        name: 'HarperCollins',
        description:
          'A major book publisher with a wide range of popular and influential books.',
      ...
      },
      {
        ...
        name: 'Simon & Schuster',
        description:
          'Publisher of bestsellers and a leading provider of high-quality books.',
      ...
      },
      {
        ...
        name: 'Macmillan',
        description:
          'Publisher known for its diverse catalog of fiction and non-fiction books.',
      ...
      },
      {
        ...
        description:
          'Publisher with a wide array of books across various genres.',
